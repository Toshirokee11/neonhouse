    ...
    <main class="main__categoria">
        ...
        <div class="overlay" id="overlay">
            <figure class="overlay__imagen">
                ...
                <img class="overlay__img imagen1 a " id="inicial" src="../public/imagenes/PIZZERIA/1.webp" alt="">
                <img class="overlay__img imagen1" src="../public/imagenes/PIZZERIA/2.webp" alt="">
