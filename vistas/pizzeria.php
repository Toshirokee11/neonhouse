...
<?php require_once "layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <div id="slider">
            <figure>
                <img src="../public/imagenes/Slider/PIZZERIA/1.webp" alt="">
                <img src="../public/imagenes/Slider/PIZZERIA/2.webp" alt="">
                <img src="../public/imagenes/Slider/PIZZERIA/3.webp" alt="">
                <img src="../public/imagenes/Slider/PIZZERIA/4.webp" alt="">
            </figure>
        </div>
    ...
    var PSV = new PhotoSphereViewer({
        panorama: '../public/imagenes/Imagenes 360/PIZZERIA/1.jpg',
