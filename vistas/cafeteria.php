...
<?php require_once "layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <div id="slider">
            <figure>
                <img src="../public/imagenes/Slider/CAFETERIA Y JUGUERIA/1.webp" alt="">
                <img src="../public/imagenes/Slider/CAFETERIA Y JUGUERIA/2.webp" alt="">
                <img src="../public/imagenes/Slider/CAFETERIA Y JUGUERIA/3.webp" alt="">
                <img src="../public/imagenes/Slider/CAFETERIA Y JUGUERIA/4.webp" alt="">
            </figure>
        </div>
